...
public sealed class OrderRoutingTests
{
    private static async Task<int> Main(string[] args)
    {
        ...
        Console.Error.WriteLine("Use 'dotnet test' to run the test suite. Use --stress or --data-audit for diagnostic runs.");
        return 1;
    }
    ...
    [Fact]
    public Task ApiStartupFailsWhenDataFileIsMissing()
    {
        var root = FindRepoRoot();
